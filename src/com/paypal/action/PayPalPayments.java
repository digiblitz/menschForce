...
public class PayPalPayments {
	...
	//=====================Properties log file configuration started here==============================
	      ...
	      // Debug.print("FileName path::::::::::::::::::::::::::::::"+fileName);
	       ...
	       //	properties.load(KlgLoginAction.class.getResourceAsStream("/companyDetails.properties"));
	       	properties.load(PayPalPayments.class.getResourceAsStream("/paypal.properties"));
    ...
    public static String[] DoDirectPaymentCode(String API_username, String API_password, String API_Signature, String method, String amount, String version, String Environ, String payAction, String ccType, String acct, String expDt, String cvvNo, String fName, String ipAdd, String emailId, String inVId, String inVoiceId1, String street,String city,String state,String zip,String ccode, String lName) {
...
//            properties = new Properties();        
// 	       // String fileName = System.getProperty("user.home")+File.separator+"paypal.properties";
// 	       // Debug.print("FileName path::::::::::::::::::::::::::::::"+fileName);
// 	        InputStream in = PayPalPayments.class.getClassLoader().getResourceAsStream("/paypal.properties");
// 	        try {               
// 	               // properties.load(new FileInputStream(fileName));
// 	        	properties.load(PayPalPayments.class.getResourceAsStream("/paypal.properties"));
// 	        	System.out.println("Property file loaded successfully");
// 	            } catch (Exception e) {
// 	                try {
// 	                  //properties.load(new FileInputStream("/paypal.properties"));
// 	                  properties.load(in);
// 	                }catch(Exception ee) {
// 	                   Debug.print("Could not load the paypal.properties");
// 	                }
// 	            }
//			 
            
            
 	       String paypal_url_nvp = properties.getProperty("paypal.urlnvp");
 	       System.out.println("Paypal url in paypalpayments class----------------------"+paypal_url_nvp);
            //url = new URL("https://api-3t.paypal.com/nvp"); //live
            url = new URL(paypal_url_nvp); //live
    ...
    public static String[] doCapture(String API_username, String API_password, String API_Signature, String method, String amount, String version, String Environ, String payAction, String authId, String completeCodeType, String invoiceId) throws Exception {
       ...
       */
            ...
            BufferedReader input;
             ...
             url = new URL(properties.getProperty("paypal.urlnvp")); //live
          //url = new URL("https://api-3t.sandbox.paypal.com/nvp"); //sandbox
